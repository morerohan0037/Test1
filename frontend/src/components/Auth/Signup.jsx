    ...
    <>
      ...
      <div className="min-h-screen relative overflow-hidden flex flex-col justify-center py-8 px-4 sm:px-6 lg:px-8 pt-20">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
          ...
          <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-pink-500/30 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-2000"></div>
          <div className="absolute bottom-1/4 left-1/3 w-80 h-80 bg-indigo-500/30 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-4000"></div>
          {/* Grid pattern */}
        ...
        <div className="relative z-10">
          <div className="sm:mx-auto sm:w-full sm:max-w-md animate-fade-in-up">
            ...
            <div className="flex items-center justify-center gap-4 mb-6 animate-fade-in-up">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl flex items-center justify-center shadow-lg transform hover:scale-110 transition-all duration-300 animate-float">
          ...
          <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md animate-fade-in-up animation-delay-600">
            <div className="bg-white/10 backdrop-blur-xl py-8 px-4 shadow-2xl ring-1 ring-white/20 sm:rounded-3xl sm:px-10 border border-white/20 hover:bg-white/15 transition-all duration-500">
              <div className="space-y-6">
                ...
                {/* Terms checkbox */}
                <div className="flex items-center text-sm animate-fade-in animation-delay-1300">
                  <input
                    id="terms"
                    name="terms"
                    type="checkbox"
                    required
                    className="h-4 w-4 text-pink-600 focus:ring-pink-500 border-white/30 rounded bg-white/10 transition-all duration-300"
                  />
                  <label htmlFor="terms" className="ml-2 text-white/80 hover:text-white transition-colors duration-300">
                    I agree to the{' '}
                    <button className="text-pink-400 hover:text-pink-300 underline transition-colors duration-300">
                      Terms of Service
                    </button>
                    {' '}and{' '}
                    <button className="text-pink-400 hover:text-pink-300 underline transition-colors duration-300">
              ...
              <div className="mt-6 text-center animate-fade-in animation-delay-2000">
                <p className="text-sm text-white/70">
                  ...
                  <button
                    type="button"
                    className="font-semibold text-pink-400 hover:text-pink-300 transition-all duration-300 hover:underline"
                  >
                    Sign in here
                  </button>
                </p>
